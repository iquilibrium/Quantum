...
export const CoursePlayer: React.FC<CoursePlayerProps> = ({
    ...
    return (
      <div className="flex items-center justify-center h-screen bg-slate-900 text-white">
        <div className="text-center p-8">
          ...
          <p className="text-slate-400 mb-6">Não foi possível carregar a aula solicitada.</p>
  ...
  // const activeModule = course.modules[activeModuleIndex]; // Moved up for safety check
  // const activeLesson = activeModule.lessons[activeLessonIndex]; // Moved up for safety check
                    ...
                    {module.lessons.map((lesson, lIdx) => {
                      ...
                      return (
                        <button
                          ...
                          disabled={isLocked}
                          className={`w-full text-left p-4 pl-6 flex items-start gap-3 text-sm transition-all border-l-[3px] ${isActive
                        ...
                        >
                          <div className={`mt-0.5 w-5 h-5 rounded-full border-[1.5px] flex items-center justify-center flex-shrink-0 transition-colors ${isDone
